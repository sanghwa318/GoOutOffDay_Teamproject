...
<script src="${pageContext.request.contextPath}/assets/plugins/OwlCarousel2-2.3.4/dist/owl.carousel.js"></script>
<script src="${pageContext.request.contextPath}/assets/plugins/OwlCarousel2-2.3.4/dist/owl.carousel.min.js"></script>
