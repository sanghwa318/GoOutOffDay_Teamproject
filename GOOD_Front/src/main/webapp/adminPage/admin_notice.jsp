...
<body>
   ...
   <div class="wrapper">
      ...
      <!-- 대제목 -->
		...
		<!-- 본문상단 영역 -->
		<div class="admin_notic_header"></div>
		<h1 class="page-header">공지사항 관리</h1>
		<!-- 본문상단 영역 끝 -->
		<!-- 본문 중단 영역 -->
		<div class="admin_notic_middle">
		<div class="form-group">
					<label for='reason' class="col-md-12"><h3>공지사항 작성</h3> </label>
					<div class="col-md-12" >
						<textarea class="form-control" id="inq_content"
						name="inq_content" style=" min-height: 400px; resize:none" placeholder="내용을 입력해주세요."></textarea>
					</div>
			</div>
		</div>
		<!-- 본문 중단 영역 끝 -->
		...
		<div class="form-group">
				...
				<button type='submit' id="add" class="btn-temp btn btn-success">등록</button>
				<button type='submit' id="upd" class="btn-temp btn btn-primary">수정</button>
					<button type='reset' id="del" class="btn-temp btn btn-danger">삭제</button>
				</div>
			</div>
		<!-- 본문 하단 영역 끝 -->
		</div><!-- 본문영역 끝 -->
