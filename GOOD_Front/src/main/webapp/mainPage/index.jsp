				...
				<div class="row good_item">
					...
					<div class="owl-carousel owl-theme" id="owl-GOOD">
						<div class="item" id="bicycle_GOOD">
							<img src="../img/GOOD_img/today_bicycle1.png" alt="오늘의 자전거 항목 추천"
						...
						<div class="item" id="walk_GOOD">
							<img src="../img/GOOD_img/today_walk2.png" alt="오늘의 걷기 항목 추천"
								style="cursor: pointer;" />
							<div class="gradientBackground"></div>
							<div class="module_header">
						...
						<div class="item" id="cas_GOOD">
							<img src="../img/GOOD_img/today_img1.png" alt="오늘의 문화체육 항목 추천"
								style="cursor: pointer;" />
							<div class="gradientBackground"></div>
							<div class="module_header">
						...
						<div class="item" id="comm_GOOD">
							<img src="../img/GOOD_img/today_crew1.png" alt="오늘의 커뮤니티 항목 추천"
								style="cursor: pointer;" />
							<div class="gradientBackground"></div>
							<div class="module_header">
