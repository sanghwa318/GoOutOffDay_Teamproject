...
<script src="../plugins/fontawesome-5.15.3/js/fontawesome.min.js"></script>
<script src="../plugins/TooltipMenu/js/cbpTooltipMenu.min.js"></script>
<script src="../plugins/TooltipMenu/js/cbpTooltipMenu.min.js"></script>
<script src="../inc/Header_Footer.js"></script>
<!-- chart.js -->
