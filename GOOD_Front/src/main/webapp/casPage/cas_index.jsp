...
.show_list .header h2:after {
	content: "";
	background-image: url("../icon_img/공연전시문화 아이콘.png");
...
.exp_list .header h2:after {
	content: "";
	background-image: url("../icon_img/창의 체험 아이콘.png");
	background-size: 100% 100%;
	width: 30px;
	height: 30px;
	display: inline-block;
...
.adu_list .header h2:after {
	content: "";
	background-image: url("../icon_img/자기계발 아이콘.png");
	background-size: 100% 100%;
	width: 30px;
	height: 30px;
	display: inline-block;
...
.sport_list .header h2:after {
	content: "";
	background-image: url("../icon_img/체육시설 아이콘.png");
	background-size: 100% 100%;
	width: 30px;
	height: 30px;
	display: inline-block;
			...
			<div class="body">
				...
				<div class="row show_list">
					<div class="header clearfix">
						...
						<div class="pull-right">
							<a
								href="<%=request.getContextPath()%>/casPage/cas_themeList.jsp?cas=showExh">더
								보기 &gt;</a>
						</div>
					</div>
					<!-- 공연 전시 캐러셀 영역 -->
				...
				<div class="row exp_list">
					<div class="header clearfix">
						...
						<div class="pull-right">
							<a
								href="<%=request.getContextPath()%>/casPage/cas_themeList.jsp?cas=exp">더
								보기 &gt;</a>
						</div>
					</div>
					<!-- 문화 창의 체험 캐러셀 영역 -->
				...
				<div class="row adu_list">
					<div class="header clearfix">
						...
						<div class="pull-right">
							<a
								href="<%=request.getContextPath()%>/casPage/cas_themeList.jsp?cas=imp">더
								보기 &gt;</a>
						</div>
					</div>
					<!-- 교육 자기계발 캐러셀 영역 -->
				...
				<div class="row sport_list">
					<div class="header clearfix">
						...
						<div class="pull-right">
							<a
								href="<%=request.getContextPath()%>/casPage/cas_themeList.jsp?cas=sportsFac">더
								보기 &gt;</a>
						</div>
					</div>
					<!-- 체육시설 캐러셀 영역 -->
