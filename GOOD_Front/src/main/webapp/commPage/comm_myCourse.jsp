		...
		<div class="row cas_list">
			...
			<div style="height: 70px;">
				...
				<div class="pull-right postbtn"
					...
					<a href="comm_myCourseWrite.jsp" class="btn btn-info"
			...
			<div class="text-center">
				<ul class="pagination" id="pagination" style="margin-top: 0;">
					<li class="page-item"><a <%if (k != 0) {%>
						href="comm_myCourse.jsp?pageNo=<%=pageNum - 4%>" <%}%>>&laquo;</a></li>
					<%
					for (int l = 1; l < 6; l++) {
					%>
					...
					<li class="page-item <%if (j == l + pageNum) {%>active<%}%>"><a
						class="page-item-a"
						href="comm_myCourse.jsp?pageNo=<%=pageNum + l%>"><%=pageNum + l%></a></li>

					<%
					}
					%>
					<li class="page-item"><a
						href="comm_myCourse.jsp?pageNo=<%=pageNum + 6%>">&raquo;</a></li>
				</ul>
			</div>
