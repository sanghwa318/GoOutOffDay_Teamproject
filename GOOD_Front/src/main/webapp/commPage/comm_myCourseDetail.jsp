		...
		<div class="container">
			...
			<div class="row">
				<div class="courseimg col-md-4">
					<img alt="코스사진" src="../img/profile_default.png" width="300">
				</div>
			...
			<a class="btn btn-default pull-left"
				href="comm_myCourse.jsp?pageNo=1">목록</a> <a
				class="btn btn-default pull-right" href="comm_myCourseEdit.jsp">코스
				수정</a>
