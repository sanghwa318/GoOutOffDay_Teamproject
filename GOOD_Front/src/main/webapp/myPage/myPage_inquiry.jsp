	...
	<div class="wrapper">
		...
		<div class="container">
			...
			<div class="col-md-10 col-md-offset-1">
				...
				<table class="table table-bordered">
					...
					<tbody id="list">
						<tr>
							...
							<td class="text-center"><a href="myPage_inquiryDetail.jsp">코스등록
									문의 드립니다.</a></td>
						</tr>
						<tr>
							...
							<td class="text-center"><a href="myPage_inquiryDetail.jsp">행사정보가
									잘못되었습니다.</a></td>
						</tr>
						<tr>
				...
				<a type="button" class="btn btn-primary pull-right" href="myPage_inquiryWrite.jsp">작성하기</a>
			</div>
		</div>
	</div>
